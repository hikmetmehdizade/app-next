...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  const navigation = useMemo<MenuItem[]>(() => {
    if (query?.workspaceId) {
      ...
      return [
        ...
        {
          name: 'Dashboard',
          href: Routes.workspaceDashboard(workspaceId),
        },
        {
          name: 'Tasks',
          href: Routes.workspaceTasks(workspaceId),
        },
        {
          name: 'Members',
    ...
    return [{ name: 'Workspaces', href: '/workspaces' }];
  }, [query?.workspaceId]);
